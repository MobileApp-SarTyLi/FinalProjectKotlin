...
class ReadDataSpotifyIndia : AppCompatActivity() {
...
//    private val redirectUri = "com.slt.mobapps://callback"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.readdataBtn.setOnClickListener{
            ...
            //Display song title
            spotifyAppRemote?.let {
                Log.d("SpotifyIndia", "HERE")
                it.playerApi.subscribeToPlayerState().setEventCallback {
                    Log.d("SpotifyIndia", "HERE 2")
    ...
    private fun connected(){
        spotifyAppRemote?.let {
            // Play a playlist India Global
            val playlistURI = "spotify:playlist:37i9dQZEVXbMWDif5SCBJq"
